...
All nodes that will be installed in the Alastria Networks must be permissioned. To ask for permission you must enter your data in this [electronic form](https://forms.gle/7CxGn2gE4GwRRLBt7) 

If an associated will want to remove a node from the network, it is kindly appreciated that a request must be notified through an issue. 

In order to perform permissioning, follow these steps (you will be asked for this information in the previous form):
